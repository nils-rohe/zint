  ...
  stages {
    stage ('Prepare fuzz test') {
      environment {
        ...
        CICTL = "${WORKSPACE}/cictl-3.11.0-linux";
        CICTL_VERSION = '3.11.0';
        CICTL_URL = 'https://s3.eu-central-1.amazonaws.com/public.code-intelligence.com/cictl/cictl-3.11.0-linux';
        FINDINGS_TYPE = 'CRASH';
        TIMEOUT = '900'
